        ...
        case 'attach':
            ...
            if(!$errors) {
               $sql= 'UPDATE '.CONFIG_TABLE.' SET allow_attachments='.db_input(isset($_POST['allow_attachments'])?1:0).
                    ...
                    ',allowed_filetypes='.db_input(ereg_replace("/\n\r|\r\n|\n|\r/", '',$_POST['allowed_filetypes'])).
        ...
        case 'api':
            ...
            if(!$errors) {
                $sql='UPDATE '.CONFIG_TABLE.' SET api_whitelist='.db_input(ereg_replace("/\n\r|\r\n|\n|\r/", ' ',$_POST['api_whitelist'])).
                    ',api_key='.db_input($_POST['api_key']).
                    ' WHERE id='.$cfg->getId();
                if(db_query($sql)) {
                    $cfg->reload();
        ...
        case 'email':
            ...
            switch($do){
                ...
                case 'create':
                    ...
                    if(!$errors) {
                        $sql='updated=NOW(),email='.db_input($_POST['email']).',name='.db_input($_POST['name']).
                    ...
                    case 'update':
                        ...
                        if(!$errors) {
                            $sql='UPDATE '.EMAIL_TEMPLATE_TABLE.' SET updated=NOW() '.
                                ',ticket_autoresp_subj='.db_input($_POST['ticket_autoresp_subj']).
                                ',ticket_autoresp_body='.db_input($_POST['ticket_autoresp_body']).
                                ',message_autoresp_subj='.db_input($_POST['message_autoresp_subj']).
                                ',message_autoresp_body='.db_input($_POST['message_autoresp_body']).
                                ',ticket_alert_subj='.db_input($_POST['ticket_alert_subj']).
                                ',ticket_alert_body='.db_input($_POST['ticket_alert_body']).
                                ',message_alert_subj='.db_input($_POST['message_alert_subj']).
                                ',message_alert_body='.db_input($_POST['message_alert_body']).
                                ',assigned_alert_subj='.db_input($_POST['assigned_alert_subj']).
                                ',assigned_alert_body='.db_input($_POST['assigned_alert_body']).
                                ',ticket_overdue_subj='.db_input($_POST['ticket_overdue_subj']).
                                ',ticket_overdue_body='.db_input($_POST['ticket_overdue_body']).
                                ',ticket_overlimit_subj='.db_input($_POST['ticket_overlimit_subj']).
                                ',ticket_overlimit_body='.db_input($_POST['ticket_overlimit_body']).
                                ',ticket_reply_subj='.db_input($_POST['ticket_reply_subj']).
                                ',ticket_reply_body='.db_input($_POST['ticket_reply_body']).
        ...
        switch($do){
            ...
            case 'create':
                ...
                if(!$_POST['priority_id'])
                    $errors['priority_id']='You must select a priority';
                if(!$errors) {
                    $sql='updated=NOW(),topic='.db_input($_POST['topic']).
                        ',dept_id='.db_input($_POST['dept_id']).
                        ',priority_id='.db_input($_POST['priority_id']).
            ...
            case 'create':
                ...
                if(!$errors){
                    ...
                    $sql=' SET updated=NOW() '.
                        ...
                        ',dept_name='.db_input($_POST['dept_name']).
                        ',dept_signature='.db_input($_POST['dept_signature']).
