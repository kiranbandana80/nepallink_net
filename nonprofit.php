...
Our goal is to provide the global standard internet solution for small business operations, placing them on the web, with our many useful internet services. We currently have users from 15 countries and over 200 business accounts.
 ...
 <p><a href="windows.php" >Windows Server</a><br/>
	...
	<strong>Non-Profit Hosting Package</strong></p>
 <p><img src="../images/host1.jpg" ><br/>
     <br>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td width="360" align="left" valign="top">      <div align="justify">
                  <p>                    <strong>Non-profit Hosting package (Special Discount) </strong> </p>
                  <p>As part of our responsibility to the communities we operate in - we're dedicated to providing the best and most affordable hosting environment to non-profit organizations. </p>
                  <p>Are you a non-profit organization? Get the best web hosting package specially devised for you needs!&nbsp; &nbsp; &nbsp; More than 2 dozen NGO has already subscribed this package. </p>
                  <p>&nbsp; &nbsp; &nbsp; </p>
                  <p>As a non-profit organization you are entitled to 30% discount of the based price on all qualified hosting packages! </p>
                  <p>&nbsp; &nbsp; &nbsp; </p>
                  <p>To get your discount, You need to submit your NGO certification and related document as required. </p>

<a href='order.php?plan=NGO_HOSTING_30PC_DISCOUNT'>
<img src='http://nepallink.net/images/order_blue.gif' border=0>
</a>
