<HTML>
<HEAD>
<TITLE>Nepal IT Jobs | Jobs in Nepal | Jobs at Nepallink | Programming Jobs Nepal | Nepal Web Programming Designer jobs | System Administrator Jobs in Nepal |  Linux System Administrator Job | Windows Server Administrator | MS Exchange Administrator | Application Server Administrator jobs | Customer Support jobs | sales marketing jobs in nepal</TITLE>
<META http-equiv=Content-Language content=en-us>
<META  name="description" content="NepalLink is a  leading  Web solutions company. Nepallink product ranges from high quality hosting services to cloud consulting, IT Administration, e-commerce solution, and dedicated web hosting as well as domain registration & web design.">
...
<table border="0" cellpadding="0" cellspacing="0" width="775">
  <tr>
    ...
    <td width="747" align="right" valign="middle" bgcolor="#E5E7E8" height="20">Career Opportunities in Nepallink Network </td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="9%" align="left" valign="top"><br />
     
	</td>
    <td width="90%" align="left" valign="top"><div align="center"><span class="style4">Career Opportunities</span><br />
          <br />
    </div>
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    ...
    <ul>
      ...
      <li> Works with company sales and marketing department to focus sales efforts on developed and graded leads and in developing campaigns to maximize sales efforts. </li>
      <li> Analyzes local market to identify market opportunities, prospective companies and associated buyers. </li>
      <li> Follows-up on referrals and self generated leads to identify buyer influences and any timing issues; monitors prospects' contract calendars; prepares monthly reports on status of leads and other reports as required. </li>
      <li> Makes sales presentations to prospective sales agent. <br>
        </li>
    </ul>
    <p>QUALIFICATION </p>
    <ul>
      <li>Demonstrated skills in the areas of consultative sales and business development. </li>
      <li>Demonstrated energy, drive, determination and persistence, even when confronted with rejection. </li>
      <li>Ability to analyze sales data and develop recommendations and solutions. </li>
      <li>Excellent flexibility in planning, organization and time management skills. </li>
      <li>Ability to carry out multiple assignments concurrently. </li>
