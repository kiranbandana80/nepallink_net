<?php /* Smarty version 2.6.13, created on 2008-04-22 05:07:49
         compiled from kbadmin_articles_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'kbadmin_articles_edit.tpl', 45, false),)), $this); ?>
<?php if ($this->_tpl_vars['html_integration'] == 'Y'): ?>
...
<?php else: ?>
<script src="javascript/js_quicktags/adminquicktags.js" type="text/javascript"></script>
<?php endif; ?>
<fieldset>
		<legend>
...
"><strong><?php echo @LANG_TITLE; ?>
:</strong> </td>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
"><input type="text" size="35" name="aTitle" value="<?php echo $this->_tpl_vars['aTitle']; ?>
" /></td>
	</tr>
	<tr>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => false), $this);?>
"><strong><?php echo @LANG_PROBLEM; ?>
:</strong> </td>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
">
			<textarea id="aShortDesc" name="aShortDesc" style="width: 100%" rows="15"><?php echo $this->_tpl_vars['aShortDesc']; ?>
</textarea>
		</td>
	</tr>
	<tr>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => false), $this);?>
"><strong><?php echo @LANG_SOLUTION; ?>
:</strong> </td>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
">
			<script type="text/javascript">if ( typeof tinyMCE == "undefined" || tinyMCE.configs.length < 1 ) edToolbar();</script>
			<textarea id="aDescription" name="aDescription" style="width: 100%" rows="25"><?php echo $this->_tpl_vars['aDescription']; ?>
</textarea>
			<?php if ($this->_tpl_vars['html_integration'] != 'Y'): ?>
			<script type="text/javascript">edCanvas = document.getElementById('aDescription');</script>
			<?php endif; ?>
		</td>
	</tr>
	<tr>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => false), $this);?>
"><strong><?php echo @LANG_DISPLAY; ?>
:</strong> </td>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
"><input type="checkbox" name="aDisplay" value="Y"<?php if ($this->_tpl_vars['aDisplay'] == 'N'): ?> <?php else: ?> CHECKED<?php endif; ?> /></td>
	</tr>
	<tr>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => false), $this);?>
"><strong><?php echo @LANG_CATEGORY; ?>
:</strong> </td>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
">
			<select name="cat[]" size="10" multiple="multiple">
			<?php $_from = $this->_tpl_vars['cat']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['entry']):
?>
			<option value="<?php echo $this->_tpl_vars['entry']['cID']; ?>
"<?php if ($this->_tpl_vars['entry']['selected'] == Y): ?> SELECTED<?php endif; ?>><?php echo $this->_tpl_vars['entry']['cName']; ?>
</option>
...
">
			<table width="100%">
				<tr>
					<td><strong><?php echo @LANG_ATTACHMENTS; ?>
</strong></td><td><strong><?php echo @LANG_DELETE; ?>
</strong></td>
				</tr>
...
?>
				<tr>
					<td width="5%" class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => false), $this);?>
" nowrap><?php echo $this->_tpl_vars['entry']['aName']; ?>
</td><td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
"><input type="checkbox" name="attach<?php echo $this->_tpl_vars['entry']['aID']; ?>
" value="Y" /></td>
				</tr>
			<?php endforeach; endif; unset($_from); ?>
			</table>
	...
	<tr>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => false), $this);?>
"><strong><?php echo @LANG_ADD_FILES; ?>
:</strong> </td>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
">
	...
	<tr>
		<td class="<?php echo smarty_function_cycle(array('values' => "row1,row2",'advance' => true), $this);?>
" colspan="2"><input type="submit" name="submit" value="<?php echo @LANG_SUBMIT; ?>
" /></td>
	</tr>
 </table>
 <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['aID']; ?>
" />
 <input type="hidden" name="aAuthor" value="<?php echo $this->_tpl_vars['uid']; ?>
" />
 <?php if ($this->_tpl_vars['action'] == 'edit'): ?>
