...
* 
* $Id: cpaint2_proxy.php,v 1.1 2006/02/03 02:07:50 Eric Barnes Exp $
* $Log: cpaint2_proxy.php,v $
* Revision 1.1  2006/02/03 02:07:50  Eric Barnes
* V1.0.0 RC2
*
* Revision 1.1  2005/12/04 18:56:06  Eric Barnes
* First Release
*
* Revision 1.1  2005/08/30 18:18:07  Eric Barnes
* *** empty log message ***
*
...
*/
  ...
  if ($url_parts['user'] != '') {
    $cp_request_header .= 'Proxy-Authorization Basic ' . base64_encode($url_parts['user'] . ':' . $url_parts['pass']) . "\r\n";
  }
