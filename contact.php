<?php
session_start();
if (isset($_POST['captcha_phrase']) && $_POST['captcha_phrase'] == $_SESSION['captcha_phrase'])
{
/**
...
Thank you for your email to NepalLink.
...
Your comment is high appriciated and we will get back to you accordingly.
...
print <<<EOF
<html>
    <head><title>aFormMail error</title><link rel=stylesheet type=text/css href=ktour.css></head>
    <body bgcolor="#E4CD4D" vlink="#AAAAAA" text="#000000" alink="#B50000" link="#B50000" leftmargin="3" topmargin="3" marginWidth="3" marginHeight="3">

<br><br>
    <h2 align=center><font color=#DDEEDD>An Error Occured</font></h2>
    <hr width=60%>
