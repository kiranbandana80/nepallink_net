...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  Our goal is to provide the global standard internet solution for small business operations, placing them on the web, with our many useful internet services. We currently have users from 15 countries and over 200 business accounts.
   ...
   <strong>PHP Hosting</a></strong> <br/>
...
<br>
<br></br> </br>
<img src="../images/service/host3.jpg" ></p>
 <p>&nbsp;</p>
 <p><br>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td width="360" align="left" valign="top">      <div align="justify">
              <img src="../images/service/phpicon.jpg">    <p> <h3>PHP Basic Hosting </h3> </p>
Nepallink offer quality secure Linux, Apache, MySQL, and PHP (LAMP) Hosting services. 
<p>Our PHP Basic hosting plans support MySQL and PostgreSQL databases; Python, Perl, and CGI; FrontPage 2003 Extensions. </p>
                  <p><strong>Browse By: </strong></p>
                    ...
                    <p><a href="phphostingbasic.php#pricing">Pricing Options </a><br/>
                   <a href="phphostingbasic.php#general"> General Features</a> <br/>
                   <a href="phphostingbasic.php#domain"> Domain Features </a><br/>
                  <a href="phphostingbasic.php#email">Email Features </a><br/>
                    <a href="phphostingbasic.php#db">Database Feature </a><br/>
					                   
                   
                    <p><br/>
					<a href="phphostingbasic.php" ><strong>View PHP Basic Hosting </strong></a><br/>
                 
				  <h3>PHP Professional Hosting </h3> 
                  </p> The PHP Professional Hosting package extends and enhances the features provided in the Basic package with more size, bandwidth, subdomains, features, more mailboxes and more web applications. 
                  <p><strong> Browse By: </strong></p>
              
                   <p><a href="phphostingpro.php#pricing1">Pricing Options </a><br/>
                   <a href="phphostingpro.php#general1"> General Features </a><br/>
                    <a href="phphostingpro.php#domain1">  Domain Features</a> <br/>
                 <a href="phphostingpro.php#email1"> Email Features</a><br/>
                 <a href="phphostingpro.php#db1"> Database Features </a><br/>
					 <a href="phphostingpro.php#add1">Additional Services and Upgrades</a>                 
                 
                   <p><br><a href="phphostingpro.php" ><strong> View PHP Professional Hosting</strong></a><br></p>                  
                   </div></td>
    <td width="49">&nbsp;</td>
  </tr>
</table>
