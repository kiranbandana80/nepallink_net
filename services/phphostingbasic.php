...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td width="360" align="left" valign="top">      <div align="justify">
                  ...
                  <p> <strong>PHP Basic Hosting </strong></p>
                  <p>Our PHP Basic hosting plans support MySQL and PostgreSQL databases; Python, Perl, and CGI; FrontPage 2003 Extensions. </p>
                  ...
                  <p>  <a id="general"><strong> General Features  
                  </strong></a></p> <table cellspacing="2" cellpadding="0" border="0" width="98%">
                    <tr>
                       <td width="60%" class="mytr">Disk Space</td>
                       <td  class="mytr">Up to 500 MB * </td>
                    </tr>
                    <tr>
                      <td class="mytd">High Availability Bandwidth </td>
                      <td class="mytd1"><p align="center">5 GB </td>
                    </tr>
                    <tr>
                  ...
                  <p> <a id="db"> <strong>Database Features: </strong> </a></p> <table cellspacing="2" cellpadding="0" border="0" width="98%">
                    ...
                    <tr>
                       <td class="mytd">Can I connect from local desktop? </td>
                     <td class="mytd1">Yes </td>
                    </tr>
                  </table>
                  <p>&nbsp;</p>
