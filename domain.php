...
<form action="domaincheck.php">
 <div style="padding:0 0 0 20px;color: #7f7f7f; font-size: 12px;">
                                                WWW. <input size="26" name="domain" onChange="javascript:this.value=this.value.toUpperCase();"/>&nbsp;
                                                <select name="tld">
							<option value="com.np" selected="selected">.COM.NP</option>
							<option value="net.np" selected="selected">.NET.NP</option>
							<option value="edu.np" selected="selected">.EDU.NP</option>
							<option value="org.np" selected="selected">.ORG.NP</option>
                                                        <option value="com" selected="selected">.COM</option>
                                                        <option value="net">.NET</option>
                                                        <option value="org">.ORG</option>
                                                        <option value="edu">.EDU</option>
